...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    await resend.emails.send({
      ...
      subject: "Seu ingresso Chapter Two — 01 de Agosto",
      html: `
        <div style="background:#000;color:#fff;padding:40px;font-family:sans-serif;max-width:600px;margin:0 auto;">
          <h1 style="font-size:32px;font-weight:bold;letter-spacing:-1px;margin:0 0 4px;">CHAPTER TWO</h1>
          <p style="color:#555;font-size:11px;letter-spacing:4px;text-transform:uppercase;margin:0 0 32px;">01 de Agosto · Lago Sul · Brasília</p>
