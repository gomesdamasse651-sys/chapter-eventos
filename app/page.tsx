  ...
  return (
    <main className="min-h-screen bg-black text-white">
      ...
      <nav className="fixed top-0 right-0 p-4 z-50">
        <Link href="/login" className="text-xs tracking-widest uppercase text-zinc-500 hover:text-white transition-colors border border-zinc-800 px-4 py-2 hover:border-zinc-500">
          Entrar
        </Link>
      </nav>
